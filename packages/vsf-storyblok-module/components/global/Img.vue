...
export default {
  ...
  computed: {
    ...
    placeholderSrc () {
      return this.placeholder || `data:image/svg+xml,%3Csvg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${this.intrinsicWidth || this.width } ${this.intrinsicHeight || this.height }"%3E%3C/svg%3E`
    },
    isSvg () {
